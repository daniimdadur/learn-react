...
import {userDetail, userUpdatePassword, userUpdateProfile} from "../../lib/api/UserApi.ts";
import {useEffectOnce, useLocalStorage} from "react-use";
import {alertError, alertSuccess} from "../../lib/alert.ts";
...
export default function UserProfile (): ReactElement {
    ...
    async function handleSubmitProfile(e: SyntheticEvent<HTMLFormElement>) {
        e.preventDefault();
        if (!token) {
            await alertError("User is not authenticated. Please log in.");
            return;
    ...
    async function handleSubmitPassword(e: SyntheticEvent<HTMLFormElement>) {
        e.preventDefault();
        if (!token) {
            await alertError("User is not authenticated. Please log in.");
            return;
    ...
    useEffectOnce(() => {
        fetchUserDetail()
            .then(() => console.log("Successfully fetching user detail"))
    });
